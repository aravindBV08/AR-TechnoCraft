    ...
    e.widget("thomaskahn.smoothDivScroll", {
        ...
        getFlickrContent: function(t, n) {
            ...
            e.getJSON(t, function(t) {
                function c(t, a) {
                    ...
                    v.load(function() {
                        ...
                        if (l === f) {
                            ...
                            r.recalculateScrollableArea(), r._showHideHotSpots(), r._trigger("addedFlickrContent", null, {
                                addedElementIds: u
                            })
                        }
                    })
                ...
                function h(t) {
                    var n = i.data("scrollableAreaHeight") / t.height,
                        r = Math.round(t.width * n),
                        s = e(t).attr("src").split("/"),
                        a = s.length - 1;
